...
zverev_career_2nd.update_traces(opacity=0.95,
                                text = zverev_to_plot['num_matches'],
                                hovertemplate='<b>Year</b>: %{x} <br>' +
                                '<b>Probability</b>: %{y} <br>' + 
                                '<b>Matches Played</b>: %{text} ')
plot(zverev_career_2nd, filename = './blog_post/plots_part2/zverev_history_2nd.html')
# ----- ##### ----- ##### ----- ##### ----- ##### ----- ##### ----- ##### 
...
plot(zverev_career_1st, filename = './blog_post/plots_part2/zverev_history_1st.html')
# ----- ##### ----- ##### ----- ##### ----- ##### ----- ##### ----- ##### 
...
plot(zverev_2ndin_accuracy, filename = './blog_post/plots_part2/zverev_recent_2ndin.html')
